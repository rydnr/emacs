...
;; Version: 1.11
;; Keywords: tools
;; VC: $Id: jdok.el,v 1.15 2000/06/09 07:26:26 david_ponce Exp $
...
;; Initial revisionnnnnnn
;;

;;; Code:
(require 'tempo)

(defconst jdok-version "1.11 $Date: 2000/06/09 07:26:26 $"
...
minibuffer. See also the `jdok-a' and `jdok-code' helper functions."
  ...
  (or (eq major-mode 'jde-mode)
      ...
      (error "Invalid major mode found. Must be 'java-mode', 'jde-mode' or 'malabar-mode'."))
