...
in the current buffer and browses the resulting HTML file."
  (interactive)
  (if (or (eq major-mode 'jde-mode) (eq major-mode 'java-mode) (eq major-mode 'malabar-mode))
      (jsee-run-doc-generator)
    (message "Invalid major mode found. Must be 'java-mode', 'jde-mode' or 'malabar-mode'."))
  )
